...
class CookieManager:
    ...
    def get_cookie(
        self, user_id: Optional[str] = None, platform: str = "xhs_pc"
    ) -> Optional[str]:
        """
        获取Cookie字符串
    ...
    def delete_cookie(
        self, user_id: Optional[str] = None, platform: Optional[str] = None
    ) -> Tuple[bool, str, int]:
        """
        删除Cookie
            ...
            try:
                ...
                if user_id is not None and platform is not None:
                    ...
                    for key in keys_to_delete:
                        ...
                        deleted_count += 1
                    logger.info(
                        f"用户 {user_id} 的所有Cookie删除成功，共删除 {deleted_count} 个"
                    )
                    ...
                    for key in keys_to_delete:
                        ...
                        deleted_count += 1
                    logger.info(
                        f"平台 {platform} 的所有Cookie删除成功，共删除 {deleted_count} 个"
                    )
    ...
    def update_cookie_status(
        self, user_id: Optional[str], platform: str, status: CookieStatus
    ) -> Tuple[bool, str]:
        """
        更新Cookie状态
